...
public class ReadOne
{
    public static void main(String[] args){
       ...
       /** try {
            ...
            // as input
            Scanner fileIn = new Scanner(new File("/Users/asan/Desktop/Projects/FileIOJava/Step1/input.txt"));
        ...
        try {
            Scanner scanner = new Scanner(new File("/Users/asan/Desktop/Projects/FileIOJava/Step1/input.txt"));
